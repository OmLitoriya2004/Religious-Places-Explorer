const Temples = [
  {
      ...
      "description": "A famous Hindu temple dedicated to Goddess Vaishno Devi, located in the Trikuta Mountains of Jammu and Kashmir.",
      "hotels_nearby": {
          "hotel_name": "Hotel Trikuta Palace",
  ...
  },
  {
      ...
      "description": "A renowned temple of Lord Venkateswara located in the hill town of Tirumala in Andhra Pradesh.",
      "hotels_nearby": {
  ...
  },
  {
      ...
      "description": "A famous shrine dedicated to Sai Baba, located in Shirdi, Maharashtra.",
      "hotels_nearby": {
  ...
  },
  {
      ...
      "description": "An important Hindu temple dedicated to Lord Jagannath, located in Puri, Odisha.",
      "hotels_nearby": {
          "hotel_name": "Mayfair Heritage",
  ...
  },
  {
      ...
      "description": "A historic Hindu temple located in the temple city of Madurai in Tamil Nadu.",
      "hotels_nearby": {
          "hotel_name": "The Gateway Hotel Pasumalai",
          "price_per_night": 3000
      },
  ...
  },
  {
      ...
      "description": "A famous Hindu temple dedicated to Lord Shiva, located on Rameswaram island in Tamil Nadu.",
      "hotels_nearby": {
          "hotel_name": "Hyatt Place Rameswaram",
          "price_per_night": 3500
      },
  ...
  },
  {
      ...
      "description": "A temple located in Prabhas Patan near Veraval in Saurashtra on the western coast of Gujarat, dedicated to Lord Shiva.",
      "hotels_nearby": {
          "hotel_name": "The Fern Residency",
          "price_per_night": 2500
      },
  ...
  },
  {
      ...
      "description": "A famous Hindu temple dedicated to Lord Ganesha located in Mumbai, Maharashtra.",
      "hotels_nearby": {
  ...
  },
  {
      ...
      "description": "A Hindu temple complex in Delhi, known for its beautiful architecture.",
      "hotels_nearby": {
  ...
  },
  {
      ...
      "description": "A Hindu temple dedicated to Lord Shiva located in the Himalayas, in Uttarakhand.",
      "hotels_nearby": {
          "hotel_name": "Sarovar Portico",
          "price_per_night": 4500
      },
  ...
  },
  {
      ...
      "description": "A sacred Hindu temple dedicated to Lord Vishnu, located in Uttarakhand.",
      "hotels_nearby": {
          "hotel_name": "The Tattva Resort",
          "price_per_night": 4000
      },
  ...
  },
  {
      ...
      "description": "A Hindu temple dedicated to Lord Krishna located in Guruvayur, Kerala.",
      "hotels_nearby": {
          "hotel_name": "Sterling Guruvayur",
          "price_per_night": 3000
      },
  ...
  },
  {
      ...
      "description": "A Buddhist temple in Bodh Gaya, marking the location where Gautama Buddha is said to have attained enlightenment.",
      "hotels_nearby": {
          "hotel_name": "Hotel Bodhgaya Gautam",
          "price_per_night": 3500
      },
  ...
  },
  {
      ...
      "description": "An important pilgrimage site for Hindus, dedicated to the goddess Kamakhya, located in Assam.",
      "hotels_nearby": {
  ...
  },
  {
      ...
      "description": "A famous Christian pilgrimage site located in Velankanni, Tamil Nadu.",
      "hotels_nearby": {
          "hotel_name": "MGM Vailankanni Residency",
  ...
  {
      "title": "Sun Temple",
      "description": "A UNESCO World Heritage Site located in Konark, Odisha, known for its unique architecture.",
      "hotels_nearby": {
          "hotel_name": "Lotus Eco Resort Konark",
          "price_per_night": 3500
      },
  ...
  },
  {
      ...
      "description": "A group of Jain temples located near Mount Abu in Rajasthan, known for their exquisite marble architecture.",
      "hotels_nearby": {
          "hotel_name": "Hotel Hillock",
          "price_per_night": 4000
      },
  ...
  {
      "title": "Sanchi Stupa",
      "description": "A Buddhist complex famous for its Great Stupa, located in Madhya Pradesh.",
      "hotels_nearby": {
          "hotel_name": "MPT Gateway Retreat",
          "price_per_night": 2500
      },
  ...
  },
  {
      ...
      "description": "A UNESCO World Heritage Site located in Hampi, Karnataka, dedicated to Lord Shiva.",
      "hotels_nearby": {
          "hotel_name": "Hyatt Place Hampi",
          "price_per_night": 3500
      },
  ...
  },
  {
      ...
      "description": "A famous shrine dedicated to Lord Shiva, located in Jammu and Kashmir.",
      "hotels_nearby": {
          "hotel_name": "The Khyber Himalayan Resort & Spa",
  ...
  },
  {
      ...
      "description": "A Hindu temple dedicated to Lord Krishna, located in Dwarka, Gujarat.",
      "hotels_nearby": {
          "hotel_name": "Club Mahindra Dwarka",
          "price_per_night": 3500
      },
  ...
  },
  {
      ...
      "description": "A Hindu temple dedicated to Lord Shiva, located in Bhubaneswar, Odisha.",
      "hotels_nearby": {
  ...
  },
  {
      ...
      "description": "A Hindu temple located in Kolkata, dedicated to the goddess Kali.",
      "hotels_nearby": {
  ...
  },
  {
      ...
      "description": "The holiest Gurdwara and the most important pilgrimage site of Sikhism, located in Amritsar, Punjab.",
      "hotels_nearby": {
          "hotel_name": "Hyatt Regency Amritsar",
          "price_per_night": 4500
      },
